  ...
  describe "#created_at" do
    context "when tweet is created more than 24h ago" do
      ...
      it "displays shortend date" do
        ...
        expect(TweetPresenter.new(tweet:, current_user: build_stubbed(:user)).created_at).to eq("Sep 1")
      end
    end
    ...
    context "when tweet is created no more than 24 hours ago" do
      it "displays date in words" do
        ...
        expect(TweetPresenter.new(tweet:, current_user: build_stubbed(:user)).created_at).to eq("about 2 hours")
      end
    end
  end
end
